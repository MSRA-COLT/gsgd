...
from .model_utils import resnet_ec_layer
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        self.ec_layer = {
            'cnn' :  resnet_ec_layer(num_blocks),
            'mlp' : []
        }
...
def ResNet110():
    return ResNet(BasicBlock, [3,8,40,3])


def ResNet110_C100():
    return ResNet(BasicBlock, [3,8,40,3], num_classes=100)
...
#     return ResNet(BasicBlock, [3,4,6,3],num_classes=1000)
#
#
#
...
#     return ResNet(Bottleneck, [3,4,23,3], num_classes=1000)
#
